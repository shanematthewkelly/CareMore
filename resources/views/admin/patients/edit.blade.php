          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.patients.update', $patient->id) }}">
              ...
              <div class="form-group">
                ...
                <br>
                <label for="insurance_company_name">Insurance Name <strong><font color="red">(Required if you have medical insurance)</font></strong></label>
                <input type="text" class="form-control" id="insurance_company_name" name="insurance_company_name" value="" />
                <label for="policy_number">Policy Number <strong><font color="red">(Required if you have medical insurance)</font></strong></label>
                <input type="text" class="form-control" id="policy_number" name="policy_number" value="" />
              </div>
